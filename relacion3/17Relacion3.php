...
<head>
    ...
    <title>Funciones CallBackv2</title>
...
<body>
    <div class="container">
        <h1>Ejercicio 17 Relación 3 - Funciones CallBackv2</h1>
    </div>

    <?php
        $arr = range(1,20);
        $pares = array_filter($arr,function ($n) {return ($n % 2 == 0);});

        $arr = range(1,40);
        $multiplosTres = array_filter($arr,function ($n) {return ($n % 3 == 0);});
        ...
        /*echo"<div class='alert alert-secondary' role='alert'>";
        $tmp = array_any($arr, function ($n) { return ($n % 5 == 0);});
        echo "Son todos los numeros positivos? ";
        echo"</div>";*/
        $pares = function ($n) 
        { 
